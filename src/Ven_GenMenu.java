...
public class Ven_GenMenu {
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Estado Civil", "Estado de Registro", "Pais",
				"Licencias", "Acotado", "Puede Capturar", "Tipo de Lugares", "Tipo de Captura", "Trofeos" }));
		comboBox.setSelectedIndex(0);

		Seleccionar_Tipo = new JButton("Ingresar");

		JLabel lblNewJgoodiesLabel = DefaultComponentFactory.getInstance()
				.createLabel("Seleccione la tabla referencial a editar");
		GroupLayout groupLayout = new GroupLayout(frame.getContentPane());
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(27)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(
								groupLayout.createSequentialGroup().addComponent(lblNewJgoodiesLabel).addContainerGap())
						.addGroup(groupLayout.createSequentialGroup()
								.addComponent(comboBox, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED, 80, Short.MAX_VALUE)
								.addComponent(Seleccionar_Tipo).addGap(54)))));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(17).addComponent(lblNewJgoodiesLabel).addGap(26)
	...
	public String get_Tabla_Type() {
		...
		String[] nombres = { "estado_civil", "estado_registro", "pais", "licencias", "acotado", "puede_cap",
				"lugares_tip", "captura_tip", "trofeos" };
