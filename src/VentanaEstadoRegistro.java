...
public class VentanaEstadoRegistro {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaEstadoRegistro window = new VentanaEstadoRegistro();
	...
	private void initialize() {
		...
		frmtdtxtfldCargo.setText("ESTADO DE REGISTRO");
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(frmtdtxtfldEstado, GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
